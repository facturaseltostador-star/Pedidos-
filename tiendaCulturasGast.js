...
const productos = {
  ...
  comida: [
    ...
    { id: 77, nombre: "Posta Surtida Kilo", imagen: "#" },
    { id: 78, nombre: "Posta Kilo", imagen: "#" },
    { id: 79, nombre: "Patacones Paquete", imagen: "#" },
    { id: 80, nombre: "Dedos de pollo Kilo", imagen: "#" },
    { id: 81, nombre: "Alitas Kilo ", imagen: "#" },
    { id: 82, nombre: "Fajitas de pollo Kilo", imagen: "#" },
    { id: 83, nombre: "Fajitas de res Kilo ", imagen: "#" },
    { id: 84, nombre: "Fajitas mixtas Kilo ", imagen: "#" },
...
document.getElementById("formPedido").addEventListener("submit", async e => {
  ...
  try {
    ...
    window.location.href = "tiendaCulturasGast.html";
  } catch (error) {
    console.error(error);
